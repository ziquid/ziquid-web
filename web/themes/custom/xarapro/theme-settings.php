...
/**
 * @file
 * Custom setting for xarapro theme.
 */
function xarapro_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  $thexpro_latest_version = file_get_contents("https://drupar.com/theme-update-info/thexpro.txt");
  $xarapro_latest_version = file_get_contents("https://drupar.com/theme-update-info/xarapro.txt");
  $theme_path = \Drupal::service('extension.list.theme')->getPath('xarapro');
  $image_folder = $GLOBALS['base_url'] . '/' . \Drupal::service('extension.list.theme')->getPath('xarapro') . '/images/theme-settings/';
  $button = "display: inline-block; background: #0984e3; color: white; margin-bottom: 10px; padding: 5px 10px";
	$form['#attached']['library'][] = 'xarapro/theme-settings';
  $form['xarapro'] = [
    '#type'       => 'vertical_tabs',
  ...
  $form['general'] = [
    '#type'  => 'details',
    '#title' => t('General'),
    '#description' => t('<h3>Thank you for using XaraPro Theme</h3>XaraPro is a premium Drupal 8, 9 theme designed and developed by <a href="https://www.drupar.com" target="_blank">Drupar.com</a>'),
    '#group' => 'xarapro',
  ];
  $form['layout'] = [
    '#type'  => 'details',
  ...
  $form['general']['general_info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Theme Info'),
    '#description' => t('<a href="https://www.drupar.com/theme/xarapro" target="_blank">Theme Homepage</a> || <a href="https://demo2.drupar.com/xarapro/" target="_blank">Theme Demo</a> || <a href="https://www.drupar.com/doc/xarapro" target="_blank">Theme Documentation</a> || <a href="https://www.drupar.com/doc/xarapro/support" target="_blank">Theme Support</a>'),
  ];
  /*
   * Layout
   */
  ...
  $form['slider']['slider_image_section']['slider_image'] = [
    ...
    '#default_value'  => theme_get_setting('slider_image', 'xarapro'),
    '#description'   => t(''),
  ];
  $form['slider']['slider_code'] = [
    ...
    '#description'   => t('Please refer to this <a href="https://www.drupar.com/doc/xarapro/homepage-slider" target="_blank">documentation page</a> for slider code tutorial.'),
  ];
  /*
   * Header
   */
  ...
  $form['header']['header_links']['header_links_section'] = [
    '#type'        => 'fieldset',
    '#description'   => t('<a href="https://www.drupar.com/doc/xarapro/how-manage-website-logo" target="_blank">Change Logo</a> || <a href="https://www.drupar.com/doc/xarapro/how-change-favicon-icon" target="_blank">Change Favicon Icon</a> || <a href="https://www.drupar.com/doc/xarapro/header-main-menu" target="_blank">Manage Main Menu</a> || <a href="https://www.drupar.com/doc/xarapro/sliding-search-form" target="_blank">Sliding Search Form</a>'),
  ];
  ...
  $form['sidebar']['animated_sidebar']['sliding_sidebar'] = [
    ...
    '#default_value' => theme_get_setting('sliding_sidebar'),
    '#description'   => t("Check this option to enable animated sidebar feature. Uncheck to hide.<br />Please refer to this tutorial for details. <a href='https://www.drupar.com/node/2092' target='_blank'>How To Create Animated Sliding Sidebar</a>"),
  ];
  ...
  $form['content']['shortcodes'] = [
    '#type'          => 'details',
    '#title'         => t('Shortcodes'),
    '#description'   => t('<p>XaraPro theme has many custom shortcodes which you can use for creating contents.</p><p>Please visit this page for list of all available shortcodes and how to use these shortcodes.</p><ul><li><a href="https://www.drupar.com/node/2085/" target="_blank">XaraPro Shortcodes</a></li><li><a href="https://www.drupar.com/node/1314" target="_blank">The-X-Pro Shortcodes</a></li></ul>'),
    '#group' => 'content_tab',
  ];
  // content -> RTL
  ...
  $form['content']['animated_content_tab']['animated_content_section']['animated_content'] = [
    ...
    '#default_value' => theme_get_setting('animated_content'),
  ...
  $form['footer']['copyright']['copyright_text'] = [
    ...
    '#description'   => t("Check this option to show website copyright text in footer. Uncheck to hide.<br />Read more: <a href='https://www.drupar.com/node/2083' target='_blank'>Copyright Text in Footer</a>"),
  ];
  ...
  $form['footer']['copyright']['copyright_text_custom'] = [
    ...
    '#default_value' => theme_get_setting('copyright_text_custom'),
    '#description'   => t("<p>Enter custom copyright text. Leave it blank to show default copyright text.</p><p>For more details, please read this tutorial: <a href='https://www.drupar.com/node/2083' target='_blank'>Copyright Text in Footer</a>"),
  ];
  /**
  ...
  $form['elements']['button']['button_default_section']['button_default'] = [
    '#type'          => 'checkbox',
    '#title'         => t('Use Default Button Settings'),
    '#default_value' => theme_get_setting('button_default'),
    '#description'   => t('Check this option to use default button. Uncheck this to customize below.'),
  ];
  ...
  $form['components']['fonts']['fonts_section']['font_src'] = [
    ...
    '#description'   => t('XaraPro theme uses following Google fonts: Noto Sans.<br />You can serve these fonts locally or from Google server.'),
  ];
  // Components -> Social
  ...
  $form['components']['font_icons']['material']['material_icon'] = [
    '#type'          => 'checkbox',
    '#title'         => t('Enable Google Material Font Icons'),
    '#default_value' => theme_get_setting('material_icon'),
    '#description'   => t('Check this option to enable Google Material Font Icons. Uncheck to disable.<br /><a href="https://www.drupar.com/node/1550" target="_blank">How to use Google Material font icons</a>'),
  ];
  ...
  $form['components']['preloader']['preloader_section']['preloader_option'] = [
    ...
    '#default_value' => theme_get_setting('preloader_option'),
  ...
  $form['components']['cookie']['cookie_message_section']['cookie_message'] = [
    ...
    '#default_value' => theme_get_setting('cookie_message'),
  ...
  $form['components']['cookie']['cookie_message_section']['cookie_message_custom'] = [
    ...
    '#default_value' => theme_get_setting('cookie_message_custom'),
  ...
  // Settings under insert codes
  include_once 'inc/settings/insert-codes.php';

/**
 * Settings under update tab.
 */
  $form['update']['update_tab'] = [
    '#type'  => 'vertical_tabs',
  ];
  // Update -> The X Pro
  $form['update']['update_thexpro'] = [
    '#type'        => 'details',
    '#title'       => t('The X Pro'),
    '#group' => 'update_tab',
  ];
  $form['update']['update_thexpro']['thexpro_latest_version'] = [
    '#type'        => 'fieldset',
    '#title'       => t('The X Pro - Latest Released Version'),
    '#description' => t("<pre>$thexpro_latest_version</pre><p><hr /></p><p><a href='https://www.drupar.com/node/1304' target='_blank'>How To Update The-X-Pro Theme</a></p>"),
  ];
  // Update -> Xara Pro
  $form['update']['update_xarapro'] = [
    '#type'        => 'details',
    '#title'       => t('XaraPro'),
    '#group' => 'update_tab',
  ];
  $form['update']['update_xarapro']['xarapro_version'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Xara Pro - Current Theme Version'),
    '#description' => t('10.1.0'),
  ];
  $form['update']['update_xarapro']['xarapro_latest_version'] = [
    '#type'        => 'fieldset',
    '#title'       => t('XaraPro - Latest Released Version'),
    '#description' => t("<pre>$xarapro_latest_version</pre><p><hr /></p><p><a href='https://www.drupar.com/node/2090' target='_blank'>How To Update XaraPro Theme</a></p>"),
  ];
  ...
  $form['license']['info'] = [
    ...
    <hr /><br /><a href="https://www.drupar.com/upgrade/xarapro" target="_blank">Upgrade to unlimited domain license</a>. Upgrade fee is $50 only.'),
  ];
  // Settings under support tab.
  $form['support']['info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('XaraPro Theme Support'),
    '#description' => t('<h4>XaraPro Documentation</h4>
    <p>Please check our documentation for detailed information on how to use XaraPro theme.<br /><a href="https://www.drupar.com/doc/xarapro" target="_blank">XaraPro Documentation</a>.</p>
    <h4>The-X-Pro Documentation</h4>
    <p>XaraPro theme uses The-X-Pro theme as the base theme. So, many things are covered in <a href="https://www.drupar.com/doc/thexpro" target="_blank">The X Pro Documentation</a>.</p>
    <hr />
    <h4>Open Support Ticket</h4>
    <p>If you need support that is beyond our theme documentation, please <a href="https://www.drupar.com/node/add/ticket" target="_blank">open a support ticket</a> on our website.</p>
    <hr />'),
  ];
